...
class SearchBarView: UIView {
    ...
    func commonInit() {
        ...
        searchBar.widthAnchor.constraint(equalTo: self.widthAnchor, multiplier: 0.875).isActive = true
        searchBar.centerXAnchor.constraint(equalTo: self.centerXAnchor).isActive = true
        
        okButton.widthAnchor.constraint(equalTo: self.widthAnchor, multiplier: 0.0625).isActive = true
        ...
        cancelButton.widthAnchor.constraint(equalTo: self.widthAnchor, multiplier: 0.0625).isActive = true
